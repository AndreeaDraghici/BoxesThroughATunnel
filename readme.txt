...
n lines follow with three integers on each separated by single spaces length[i],width[i],height[i],and which are length, width and height in feet of the i-th box.
